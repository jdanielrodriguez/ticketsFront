...
declare var $: any
@Component({
  selector: 'app-drafts-bis',
  templateUrl: './drafts-bis.component.html',
  styleUrls: ['./drafts-bis.component.css']
})
export class DraftsBisComponent implements OnInit {
  title:string = "Drafts Bis"
