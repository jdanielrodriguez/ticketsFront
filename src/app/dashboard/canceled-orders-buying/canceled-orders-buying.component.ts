...
declare var $: any
@Component({
  selector: 'app-canceled-orders-buying',
  templateUrl: './canceled-orders-buying.component.html',
  styles: []
})
export class CanceledOrdersBuyingComponent implements OnInit {
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllBuyersCanceledOrders(this.idCurrent)
                        .then(response => {
