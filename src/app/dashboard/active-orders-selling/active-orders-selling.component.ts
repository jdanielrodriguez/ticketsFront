...
declare var $: any
@Component({
  selector: 'app-active-orders-selling',
  templateUrl: './active-orders-selling.component.html',
  styles: []
})
export class ActiveOrdersSellingComponent implements OnInit {
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllSellersOrders(this.idCurrent)
                        .then(response => {
