...
declare var $: any
@Component({
  selector: 'app-delivered-orders-selling',
  templateUrl: './delivered-orders-selling.component.html',
  styles: []
})
export class DeliveredOrdersSellingComponent implements OnInit {
  tipoUsuario:number = +localStorage.getItem('currentTipoUsuarioId');
  title:string = "Delivered Orders"
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllSellersDeliveredOrders(this.idCurrent)
                        .then(response => {
