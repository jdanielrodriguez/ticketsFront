...
declare var $: any
@Component({
  selector: 'app-active-orders-buying',
  templateUrl: './active-orders-buying.component.html',
  styles: []
})
export class ActiveOrdersBuyingComponent implements OnInit {
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllBuyersOrders(this.idCurrent)
                        .then(response => {
