...
declare var $: any
@Component({
  selector: 'app-disabled-bis',
  templateUrl: './disabled-bis.component.html',
  styleUrls: ['./disabled-bis.component.css']
})
export class DisabledBisComponent implements OnInit {
  title:string = "Disabled Bis"
  ...
  cargarAll(){
    ...
    this.mainService.getAllMineDraft(data)
                      .then(response => {
                        this.Table = response
                        this.blockUI.stop();
                      }).catch(error => {
