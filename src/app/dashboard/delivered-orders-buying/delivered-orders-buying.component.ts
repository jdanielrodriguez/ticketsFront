...
declare var $: any
@Component({
  selector: 'app-delivered-orders-buying',
  templateUrl: './delivered-orders-buying.component.html',
  styles: []
})
export class DeliveredOrdersBuyingComponent implements OnInit {
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllBuyersDeliveredOrders(this.idCurrent)
                        .then(response => {
