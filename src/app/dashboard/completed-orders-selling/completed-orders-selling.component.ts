...
declare var $: any
@Component({
  selector: 'app-completed-orders-selling',
  templateUrl: './completed-orders-selling.component.html',
  styleUrls: ['./completed-orders-selling.component.css']
})
export class CompletedOrdersSellingComponent implements OnInit {
  tipoUsuario:number = +localStorage.getItem('currentTipoUsuarioId');
  title:string = "Completed Orders"
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllSellersCompletedOrders(this.idCurrent)
                        .then(response => {
