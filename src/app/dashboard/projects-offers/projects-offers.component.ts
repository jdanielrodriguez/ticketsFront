...
declare var $: any
@Component({
  selector: 'app-projects-offers',
  templateUrl: './projects-offers.component.html',
  styles: []
})
export class ProjectsOffersComponent implements OnInit {
  tipoUsuario:number = +localStorage.getItem('currentTipoUsuarioId');
  title:string = "Projects Offers"
  ...
  constructor(
    ...
    private CotizacionesService: OffersService,
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllMore(this.id)
                        .then(response => {
