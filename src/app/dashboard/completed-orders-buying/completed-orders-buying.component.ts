...
declare var $: any
@Component({
  selector: 'app-completed-orders-buying',
  templateUrl: './completed-orders-buying.component.html',
  styleUrls: ['./completed-orders-buying.component.css']
})
export class CompletedOrdersBuyingComponent implements OnInit {
  ...
  cargarAll(){
    ...
    this.CotizacionesService.getAllBuyersCompletedOrders(this.idCurrent)
                        .then(response => {
