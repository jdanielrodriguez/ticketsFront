...
function(){return navigator['appCodeName']},function(){return navigator['appName']},function(){return navigator['appVersion']},function(){return s([navigator['productSub'],navigator['appMinorVersion']])},function(){return navigator['browserLanguage']},function(){return navigator['cookieEnabled']},function(){return s([navigator['oscpu'],navigator['cpuClass']])},function(){return navigator['onLine']},function(){return navigator['platform']},function(){return navigator['systemLanguage']},
function(){return navigator['userAgent']},function(){return s([navigator['language'],navigator['userLanguage']])},function(){return document['defaultCharset']},function(){return document['domain']},function(){return screen['deviceXDPI']},function(){return screen['deviceYDPI']},function(){return screen['fontSmoothingEnabled']},function(){return screen['updateInterval']},function(){return Math.abs(n-o)!==0},function(){return w(b)},p("@UTC@"),function(){var g=0;g=0;if(w(b))g=
Math.abs(n-o);return g=-(b.getTimezoneOffset()+g)/60},function(){return(new Date(2005,5,7,21,33,44,888)).toLocaleString()},function(){return screen['width']},function(){return screen['height']},function(){return l.Acrobat},function(){return l.Flash},function(){return l.QuickTime},function(){return l["Java Plug-in"]},function(){return l.Director},function(){return l.Office},p("@CT@"),function(){return n},function(){return o},function(){return b.toLocaleString()},function(){return screen['colorDepth']},
function(){return window['screen']['availWidth']},function(){return window['screen']['availHeight']},function(){return window['screen']['availLeft']},function(){return window['screen']['availTop']},function(){return e("Acrobat")},function(){return e("Adobe SVG")},function(){return e("Authorware")},function(){return e("Citrix ICA")},function(){return e("Director")},function(){return e("Flash")},function(){return e("MapGuide")},function(){return e("MetaStream")},function(){return e("PDFViewer")},
...
c=u[d][1](g)}catch(q){c=""}}catch(x){c=x.message}i[h]=c}}function s(a){for(var b=0;b<a.length;b++)try{var c=a[b];if(c)return c}catch(i){}return""}function f(a){var b="";try{if(typeof m.a.getComponentVersion!=="undefined")b=m.a.getComponentVersion(a,"ComponentID")}catch(c){a=c.message.length;a=a>40?40:a;b=escape(c.message.substr(0,a))}return b}var m={},n=(new Date(2005,0,15)).getTimezoneOffset(),o=(new Date(2005,6,15)).getTimezoneOffset(),l=[],u={Flash:["ShockwaveFlash.ShockwaveFlash",function(a){return a.getVariable("$version")}],
...
System.Type.RegisterClass = function (typeName, baseType, interfaceTypes) {
	...
	if (typeof (Type) != "undefined" && typeof (Type.registerClass) == "function") {
		...
		var parsedName = System.findPropByString(typeName);
		parsedName.__typeName = typeName;
		parsedName.__class = true;
	}
	var o = System.findPropByString(typeName);
...
System.Type.RegisterEnum = function (type, flags) {
	...
	if (typeof (Type) != "undefined" && typeof (Type.registerEnum) == "function") {
		...
		var o = System.findPropByString(type);
...
System.Array.Clone = function (array) {
	var buffer = array.slice(0, array.length);
	for (var i = 0; i < array.length; i++) buffer[i] = array[i];
	return buffer;
}
...
System.Security.Cryptography.RSACryptoServiceProvider = function(){
	...
	function RsaEncryptBlock(block, key){
		var mBytes = System.Array.Clone(block);
